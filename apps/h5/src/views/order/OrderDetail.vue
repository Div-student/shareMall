...
const APPLY_AFTERSALE_STATUSES = ['paid', 'shipped', 'received', 'completed'];

function canApplyAftersale(status?: string) {
  return status ? APPLY_AFTERSALE_STATUSES.includes(status) : false;
}
